#define INVERT_Y 1    // инвертировать по вертикали (если дождь идёт вверх)Vertikal umkehren (Wenn es nach oben regnet)
#define INVERT_X 0    // инвертировать по горизонтали (если текст не читается)Horizontal umkehren (Wenn Text nicht liesbar ist)

// Text für Text-Modus
String disp_text = "Test";
...
#define TOTAL_EFFECTS 11  // Anzahl der Effekte
...
#include <SPI.h>
#include "GyverButton.h" # !!!!!!!!!! Gyver entfernen !!!!!!!!!!!
#include "fonts.h"
